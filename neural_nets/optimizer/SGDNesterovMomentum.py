...
class SGDNesterovMomentumParamsInitVisitor(TrainLayerVisitor):
    def __init__(self):
        self.params = []
...
class SGDNesterovMomentumWeightsUpdateVisitor(TrainLayerVisitor):
    def __init__(self, learning_rate: np.float64, mu: np.float64, model_backward_run: list, velocity_params: list):
